    ...
    <ul className="about_tuto_list">
      ...
      <li className="list_02">
        ...
        <div className="desc_box fl_r">
          ...
          <em className="emph_custom">
            <span className="txt_b_m">내 레벨에 맞춰 </span>내가 직접 선택하는
            1:1 맞춤형 공부{" "}
          </em>
          ...
          <p>
            ...
            <span className="txt_b_p">외국인 프리토킹 코스까지 직접 설계</span>
          </p>
          <p>
            <span className="txt_b_p">
      ...
      <li className="list_03">
        ...
        <div className="desc_box fl_l">
          ...
          <em className="emph_custom">
            <span className="txt_b_m">최근 이슈도 OK! </span>매주 업데이트 되는
            9,000개 학습 주제
          </em>
          ...
          <p>
            ...
            시험,{" "}
            <span className="txt_b_p">TOEIC, TOEFL Speaking, IELTS 등</span>
          </p>
          <p>

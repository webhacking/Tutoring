...
const AboutPrice = () => (
  <div className="main_common main_about_price">
    <div className="price_wrap">
      <em class="tit_sub">튜터링만의 특허 기술로 만든</em>
      <h3 class="tit_item">반값으로 영어공부</h3>
      <p class="txt_g">
        <b>콜센터 운영을 대체하는 최첨단 기술</b>
        예약 없이 실시간 튜터를 연결하는
        <span class="txt_b_m">RTC(Real Time Communication)기술</span>
      </p>
      <p class="txt_g">
      ...
      <ul class="list_obtain">
        <li>
          국내최초 모바일 1:1회화
          <br />
          독점적 특허 보유
          <span class="txt_info">특허 제 10-1771797호</span>
        </li>
        <li>
          2018 KCSA 소비자만족도
          <br />
